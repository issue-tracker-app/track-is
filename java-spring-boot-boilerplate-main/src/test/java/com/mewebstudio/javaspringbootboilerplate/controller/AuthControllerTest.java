...
class AuthControllerTest {
    ...
    private final AuthTokenResponse tokenResponse = Instancio.create(AuthTokenResponse.class);
    ...
    void given_whenLogin_thenAssertBody() {
        ...
        // When
        ResponseEntity<AuthTokenResponse> response = authController.login(loginRequest);
        // Then
