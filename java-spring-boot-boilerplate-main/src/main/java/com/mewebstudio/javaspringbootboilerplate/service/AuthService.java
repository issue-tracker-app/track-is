...
import com.mewebstudio.javaspringbootboilerplate.dto.response.auth.AuthTokenResponse;
...
public class AuthService {
     ...
     */
    public AuthTokenResponse login(String email, final String password, final Boolean rememberMe) {
        ...
        try {
            ...
            TokenResponse tokenResponse = generateTokens(UUID.fromString(jwtUserDetails.getId()), rememberMe);
            return AuthTokenResponse.builder().name(fullName).tokenResponse(tokenResponse).build();
        } catch (NotFoundException e) {
